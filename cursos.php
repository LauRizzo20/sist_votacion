...
if ($input['action'] == 'edit') {
    ...
    $sql = "UPDATE tbl_curso SET ano_curso='{$input['ano']}', division_curso='{$input['division']}', grupo1_curso='{$input['grupo1']}', grupo2_curso='{$input['grupo2']}' WHERE id_curso={$input['id']}";
    print_r($sql);
    $mysqli->query($sql);
